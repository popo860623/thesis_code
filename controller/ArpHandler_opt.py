...
class ArpHandler(app_manager.RyuApp):
    ...
    def create_Cap_Mat(self):
        ...
        for node in range(G.number_of_nodes()):
            for adj in G[node]:
                ...
                self.cap_mat[node+1, adj +
                             1] = int(G[node][adj][0]['bandwidth'][0:pos-1] + '000')
    ...
    def predictor(self, load=0):
        ...
        for i in range(len(path_list)):
            ...
            if weights[i] > 0:
                priority = int(1000000/weights[i])
            else:
                priority = 50000
            if priority >= 65545:
                priority = 65535
    ...
    def get_linkbw_matrix(self):
        ...
        if total_util > 0.01:
            ###################### Write Util ###########################
            with open('result_opt_100ms.txt', 'a') as f:
            ...
            ###################### Write Throughput ###########################
            with open('result_opt_100ms_bw.txt', 'a') as f:
